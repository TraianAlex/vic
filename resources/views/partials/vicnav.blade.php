<section class="menu cid-qBPDpuwyM3" once="menu" id="menu2-1m" data-rv-view="503">
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
            ...
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="https://vic.com.ro">
                         <img src="assets/images/traian-s-640x426.jpg" alt="Traian Alexandru" title="Traian Alexandru" media-simple="true" style="height: 4.5rem;">
                    </a>
                </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                ...
                </li><li class="nav-item"><a class="nav-link link text-black display-4" href="/services"><span class="mbri-mobile2 mbr-iconfont mbr-iconfont-btn"></span>
                        Services

    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                ...
                <p class="mbr-text align-center mbr-white pb-3 mbr-fonts-style display-7">Laravel / Codeigniter / custom framework<br>Bootstrap / jQuery / Vue / AngularJS<br>MySQL / SQLite / GIT / AWS S3&nbsp;<br></p>
            </div>
        </div>
    </div>
</section>

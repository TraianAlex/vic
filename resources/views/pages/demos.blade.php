    ...
    <div class="container-fluid">
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-2">
                <div class="card-wrapper">
                    <div class="card-img">
                        <a href="/solitaire"><img src="assets/images/03.jpg" alt="Traian" title="Traian" media-simple="true"></a>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title pb-3 mbr-fonts-style display-7">Solitaire</h4>
                        <p class="mbr-text mbr-fonts-style display-7">game</p>
                    </div>
                </div>
            </div>
